...
/**
 * dark-memory-mcp platform package (win32-arm64).
 *
 * Spawns the Go binary in bin/dark-mem-mcp.exe with inherited stdio
 * so the MCP host's JSON-RPC stream passes through unchanged.
 */

const path = require('path');
const { spawn } = require('child_process');

const BINARY_NAME = 'dark-mem-mcp.exe';
