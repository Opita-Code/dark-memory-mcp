...
func seedDirtyDB(t *testing.T, dbPath string) {
	...
	stmts := []string{
		...
		`CREATE TABLE constitutions (id INTEGER PRIMARY KEY AUTOINCREMENT, constitution_id TEXT NOT NULL, version TEXT NOT NULL, label TEXT, source TEXT NOT NULL, file_path TEXT NOT NULL, parsed_json TEXT NOT NULL, sha256 TEXT NOT NULL, enabled INTEGER NOT NULL DEFAULT 1, created_at TEXT NOT NULL, activated_at TEXT, UNIQUE(constitution_id, version))`,
